  ...
  return (
    ...
    <div className='contact-container'>
        ...
        <img className='gmail' src={require('../icons/gmail-icon.png')} alt="" /><span className='email'>alanxavierlasco@gmail.com</span>
              ...
              <div className="card">
                  <a className="social-link1" href='https://github.com/alanlasco' target='_blank'>
                  ...
                  <a className="social-link2" href='https://www.linkedin.com/in/alan-xavier-lasco/' target='_blank'>
                  ...
                  <a className="social-link3" href='https://drive.google.com/file/d/1KWsuLtfybskNFc8DhwPmBqLW6AEI8WLA/view?usp=sharing' target='_blank'>
                      <img className='cv' src={require('../icons/cv.png')} alt="" />
                  </a>
              </div>          
